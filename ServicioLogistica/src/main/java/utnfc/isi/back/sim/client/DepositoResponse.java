...
/**
 * DTO para respuesta de depósitos del servicio de administración
 */
public class DepositoResponse {
    ...
    public DepositoResponse(Integer id, String nombre, String direccion, 
                           BigDecimal latitud, BigDecimal longitud, 
                           BigDecimal costoDiario, Integer capacidadMax) {
        this.id = id;
        this.nombre = nombre;
