...
/**
 * DTO para solicitar la creación de una ruta al servicio de logística
 */
public class RutaRequest {
    ...
    public RutaRequest(Long solicitudId, String origenCoordenadas, String destinoCoordenadas,
